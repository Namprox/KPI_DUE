            ...
            try {
              ...
              return [
                id,
                {
                  ...
                  xong: chamTay.filter(
                    (ct) =>
                      Number(ct.TrangThaiDong) === TRANG_THAI_DONG.DA_CHOT,
                  ).length,
                },
              ];
            } catch (error) {
    ...
    <div className="page-container">
      ...
      <div className="page-header">
        ...
        <span className="breadcrumb">
          Hồ sơ đã nộp mà đơn vị của bạn được giao thẩm định ít nhất một tiêu
          chí - xem tiến độ theo từng hồ sơ
        </span>
      </div>
        ...
        {isLoading ? (
          ...
          <div className="cd-empty">
            ...
            <h3 style={{ color: "#334155", margin: "0 0 6px 0" }}>
              Không có phiếu nào chờ chấm
            </h3>
            <p style={{ margin: 0 }}>
              Hàng đợi trống nghĩa là mọi phiếu thuộc phần việc của đơn vị bạn
              đã được chấm xong, hoặc chưa có giảng viên nào gửi phiếu lên.
            </p>
          </div>
        ) : (
                  ...
                  return (
                    <tr key={p.IdPhieu}>
                      ...
                      <td>
                        <div className="cd-progress-stack">
                          <TienDoCham
                            xong={xong}
                            tong={tong}
                            nhan="Phần bạn thẩm định"
                          />
                          {toanPhieu === undefined ? (
                            <div className="cd-progress-ghichu">
                              <i className="fa-solid fa-spinner fa-spin"></i>{" "}
                              Đang tính tiến độ toàn phiếu...
                            </div>
                          ) : toanPhieu === null ? (
                            <div className="cd-progress-ghichu">
                              Không tải được tiến độ toàn phiếu
                            </div>
                          ) : (
                            <TienDoCham
                              xong={toanPhieu.xong}
                      ...
                      <td style={{ textAlign: "right" }}>
                        ...
                        >
                          <i className="fa-solid fa-pen-to-square"></i> Thẩm
                          định
                        </button>
                      </td>
                    </tr>
