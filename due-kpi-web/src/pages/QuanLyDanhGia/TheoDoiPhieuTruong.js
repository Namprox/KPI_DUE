    ...
    <div className="page-container">
      ...
      >
        <div style={{ fontSize: "13px", color: "#1e40af" }}>
          ...
          ></i>
          Trang này <b>không có nút duyệt phiếu lẻ</b>. Hiệu trưởng phê duyệt
          theo GÓI KPI của từng Khoa -{" "}
          <button
            className="cd-link-btn"
            onClick={() => navigate("/truong/to-trinh")}
          >
        ...
        >
          <div className="form-group" style={{ marginBottom: "15px" }}>
            ...
            <SearchSelect
              ...
              options={[
                {
                  value: TRANG_THAI.NHAP,
                  label: "1 - Giảng viên kê khai lại từ đầu",
                },
                {
                  value: TRANG_THAI.THAM_DINH,
                  label: "2 - Đơn vị thẩm định lại",
                },
                {
                  value: TRANG_THAI.CHO_TK_DUYET,
                  label: "3 - Trưởng khoa chốt lại",
                },
              ]}
            />
            <div className="cd-hint">
              <i className="fa-solid fa-circle-info"></i> Về bước 1 xóa cả điểm
              giảng viên; bước 2 xóa điểm đơn vị và điểm chính thức; bước 3 chỉ
              xóa kết luận cấp Trường. Tiêu chí chấm tự động luôn giữ nguyên.
            </div>
          </div>
        </LyDoModal>
      )}
