                      ...
                      {items.map((tc, index) => {
                        ...
                        if (autoInfo) {
                          ...
                          const thangDiemAuto = [
                            ...
                            (a, b) =>
                              (a.ThuTuHienThi ?? 0) - (b.ThuTuHienThi ?? 0),
                          );
                          ...
                          const phsvThieuCanCu =
                            isPhsv &&
                            !phsvChot &&
                            Number(autoInfo.DiemTuDong || 0) > 0;
                              ...
                              {isPhsv && (phsvChot || phsvThieuCanCu) && (
                                ...
                                >
                                  <span className="pl2-phsv-tb-label">
                                    <i className="fa-solid fa-users"></i> Điểm
                                    trung bình phản hồi sinh viên:
                                  </span>
                                  {phsvChot ? (
                                    ...
                                    <span className="pl2-phsv-tb-empty">
                                      ...
                                      Chưa có đợt chốt điểm phản hồi sinh viên
                                      cho năm này - điểm ở trên chưa có căn cứ
                                    </span>
                                  )}
                                </div>
                              )}
                        ...
                        const fileList =
                          formData[tc.IdTieuChi]?.DanhSachFile || [];
                        const nckhList =
                          formData[tc.IdTieuChi]?.DanhSachNCKH || [];
