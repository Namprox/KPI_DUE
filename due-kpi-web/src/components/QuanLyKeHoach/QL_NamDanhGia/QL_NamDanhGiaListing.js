...
import "../../../css/QuanLyKeHoach/QL_NamDanhGia.css";

const QL_NamDanhGiaListing = ({
  data,
  onEdit,
  onDelete,
  isLoading,
      ...
      {isLoading ? (
        ...
        >
          ...
          <h3 style={{ color: "#e74c3c", margin: "0 0 10px 0" }}>
            Chưa có năm đánh giá nào được tạo
          </h3>
        </div>
      ) : (
        <>
            ...
            <thead>
              <tr>
                ...
                <th width="20%" style={{ textAlign: "center" }}>
                  THỜI GIAN GV TỰ ĐÁNH GIÁ
                </th>
                <th width="20%" style={{ textAlign: "center" }}>
                  THỜI GIAN CẤP TRÊN DUYỆT ĐIỂM
                </th>
            ...
            <tbody>
              {paginatedData.map((item) => (
                <tr key={item.IdNam}>
                  ...
                  >
                    {formatDate(item.NgayMoTuDanhGia)}{" "}
                    <i
                      className="fa-solid fa-arrow-right"
                      style={{ color: "#ccc", margin: "0 5px" }}
                    ></i>{" "}
                    {formatDate(item.NgayDongTuDanhGia)}
                  </td>
                  <td
                    style={{
                      textAlign: "center",
                  ...
                  >
                    {formatDate(item.NgayMoDanhGiaCapTren)}{" "}
                    <i
                      className="fa-solid fa-arrow-right"
                      style={{ color: "#ccc", margin: "0 5px" }}
                    ></i>{" "}
                    {formatDate(item.NgayDongDanhGiaCapTren)}
                  </td>
