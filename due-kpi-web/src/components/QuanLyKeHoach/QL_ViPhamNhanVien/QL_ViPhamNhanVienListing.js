...
const QL_ViPhamNhanVienListing = ({
  data,
  onEdit,
  onDelete,
  isLoading,
      ...
      {isLoading ? (
        ...
        >
          ...
          <h3 style={{ color: "#7f8c8d", margin: "0 0 10px 0" }}>
            {selectedNam
              ? `Chưa ghi nhận vi phạm nhân viên nào trong năm ${selectedNam}`
              : "Chưa ghi nhận vi phạm nhân viên nào"}
          </h3>
          <p style={{ margin: 0, fontSize: "14px" }}>
            Thử đổi bộ lọc năm / đơn vị / nhân viên để xem dữ liệu khác.
          </p>
        </div>
      ) : (
        <>
                  ...
                  <td style={{ textAlign: "center" }}>
                    {item.DiemTru != null ? (
                      ...
                      >
                        ...
                        {/* Căn cứ khi trừ cao hơn mức tối thiểu của danh mục */}
                        {item.LyDoDieuChinh && (
                          <i
                            className="fa-solid fa-circle-info"
                            title={`Căn cứ điều chỉnh: ${item.LyDoDieuChinh}`}
...
export default QL_ViPhamNhanVienListing;
