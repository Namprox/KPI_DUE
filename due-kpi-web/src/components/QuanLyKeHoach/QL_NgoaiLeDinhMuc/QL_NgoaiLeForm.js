...
const QL_NgoaiLeForm = ({ isOpen, onClose, onSubmit, formData, setFormData, isEditing, namList, nhanVienList }) => {
    ...
    const handleLoaiNgoaiLeChange = (e) => {
        ...
        if (loai === 1) {
            ...
            updated.HeSoGiamGiang = 0.10;
        } else if (loai === 7) {
            updated.HeSoNckh = 1.20;
        }
            ...
            <div className="modal-box form-modal-box" style={{ width: '90%', maxWidth: '700px' }}>
                <div className="modal-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    <h3 style={{ margin: 0, paddingRight: '20px', lineHeight: '1.4' }}>
                        {isEditing ? "Cập nhật ngoại lệ định mức" : "Thêm mới ngoại lệ định mức"}
                    </h3>
                ...
                <div className="modal-body" style={{ padding: '25px', maxHeight: '75vh', overflowY: 'auto' }}>
                    <form id="ngoaiLeForm" onSubmit={onSubmit}>
                        ...
                        {!isEditing && selectedLoai > 0 && (
                            <div style={{ background: '#f8fafc', padding: '15px', borderRadius: '8px', border: '1px solid #e2e8f0', marginBottom: '20px' }}>
                                <h4 style={{ margin: '0 0 12px 0', fontSize: '14px', color: '#334155' }}>
                                    <i className="fa-solid fa-sliders" style={{ marginRight: '6px' }}></i> Thiết lập thông số giảm/tăng định mức
                                </h4>
                                ...
                                {selectedLoai === 1 && (
                                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                                        ...
                                        />
                                        <label htmlFor="MienNckh" style={{ margin: 0, cursor: 'pointer', fontWeight: '600', color: '#1e293b' }}>
                                ...
                                {selectedLoai === 5 && (
                                    <div className="form-group">
                                        ...
                                        <input
                                            ...
                                            name="HeSoGiamGiang"
                                            className="form-input"
                                            value={formData.HeSoGiamGiang ?? 0.10}
                                            onChange={handleChange}
                                ...
                                {(selectedLoai === 2 || selectedLoai === 3 || selectedLoai === 8) && (
                        ...
                        <div className="form-grid-2" style={{ marginBottom: '20px' }}>
                            <div className="form-group">
                                <label>Từ ngày <span className="text-red">*</span></label>
                                <Calendar
                        ...
                        <div className="form-group" style={{ marginBottom: '20px' }}>
                            <label>
                                Lý do ngoại lệ {selectedLoai === 8 && <span className="text-red">* (Bắt buộc đối với loại 8)</span>}
                            </label>
                            <textarea
                                name="LyDo"
                                className="form-input"
                        ...
                        {isEditing && (
                            <div className="form-group" style={{ display: 'flex', alignItems: 'center', gap: '10px', marginTop: '10px' }}>
                                <input
                                    ...
                                    style={{ width: '18px', height: '18px', cursor: 'pointer' }}
                                />
                                <label htmlFor="TrangThai" style={{ margin: 0, cursor: 'pointer', fontWeight: '600' }}>
