          ...
          <form id="loaiViPhamForm" onSubmit={onSubmit}>
            <div className="form-grid-2" style={{ marginBottom: "20px" }}>
              <div className="form-group">
                <label style={labelStyle}>
                  Nhóm vi phạm <span className="text-red">*</span>
                </label>
                <SearchSelect
                  name="IdNhomVp"
              ...
              <div className="form-group">
                <label style={labelStyle}>
                  Mã loại vi phạm <span className="text-red">*</span>
                </label>
                <input
                  type="text"
                  name="MaLoaiViPham"
                ...
                />
                <div style={hintStyle}>
                  Không trùng với mã đã có, tối đa 50 ký tự.
                </div>
              </div>
            </div>
            ...
            <div className="form-grid-2" style={{ marginBottom: "20px" }}>
              <div className="form-group">
                ...
                />
                <div style={hintStyle}>
                  Theo quy định, mặc định 1 điểm / 1 nội dung.
                </div>
              </div>
              <div className="form-group">
            ...
            <div className="form-group" style={{ marginBottom: "20px" }}>
              <label style={labelStyle}>
                Nội dung vi phạm <span className="text-red">*</span>
              </label>
              <textarea
                name="NoiDung"
                className="form-input"
            ...
            <div className="form-group" style={{ marginBottom: "20px" }}>
              ...
              />
              <div style={hintStyle}>
                Nếu điền, người ghi nhận sẽ <strong>bắt buộc</strong> phải tải
                lên tệp PDF biên bản/hồ sơ.
              </div>
            </div>
            ...
            >
              ...
              >
                <input
                  type="checkbox"
                  name="ChoPhepKhoaChuQuan"
                  checked={!!formData.ChoPhepKhoaChuQuan}
            ...
            <div className="form-group" style={{ marginBottom: "20px" }}>
              ...
              {moiDonVi && (
                ...
                >
                  ...
                  ></i>
                  Đang bật "Mọi đơn vị chủ trì" nên danh sách cố định không còn
                  tác dụng.
                </div>
              )}
              <div
                style={{
                  ...
                  borderRadius: "8px",
                  padding: "10px",
                  opacity: moiDonVi ? 0.5 : 1,
                  pointerEvents: moiDonVi ? "none" : "auto",
                }}
              >
                {donViList.length === 0 ? (
                  ...
                  donViList.map((dv) => (
                    ...
                    >
                      <input
                        type="checkbox"
                        checked={(formData.IdDonViGhiNhanList || []).includes(
                          dv.IdDonVi,
                        )}
                      ...
                      />
                      <span className="code-pill" style={{ fontSize: "12px" }}>
                        {dv.MaDonVi}
                      </span>
