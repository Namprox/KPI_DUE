...
const QL_ChucDanhForm = ({ isOpen, onClose, onSubmit, formData, setFormData, isEditing }) => {
            ...
            <div className="modal-box form-modal-box" style={{ width: '90%', maxWidth: '600px' }}>
                <div className="modal-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                    <h3 style={{ margin: 0, paddingRight: '20px', lineHeight: '1.4' }}>
                        {isEditing ? "Cập nhật Chức danh" : "Thêm Chức danh mới"}
                    </h3>
                ...
                <div className="modal-body" style={{ padding: '25px' }}>
                    <form id="cdForm" onSubmit={onSubmit}>
                        ...
                        <div className="form-group" style={{ display: 'flex', alignItems: 'center', marginTop: '15px' }}>
                            <input type="checkbox" name="TrangThai" id="ttChucDanh" checked={formData.TrangThai !== false} onChange={handleChange} style={{ width: '18px', height: '18px', marginRight: '10px' }} />
                            <label htmlFor="ttChucDanh" style={{ margin: 0, cursor: 'pointer', fontWeight: '500' }}>Đang hoạt động</label>
                        </div>
                    </form>
                </div>
                <div className="modal-footer" style={{ display: 'flex', flexWrap: 'wrap', gap: '10px' }}>
                    ...
                    <button type="submit" form="cdForm" className="btn-submit"><i className="fa-solid fa-floppy-disk" style={{ marginRight: '5px' }}></i> Lưu</button>
                </div>
            </div>
        </div>
    );
...
export default QL_ChucDanhForm;