...
import '../../../css/CriteriaManagement/QL_NhomNhiemVu.css';

const QL_NhomNhiemVuListing = ({ data, onEdit, onDelete, isLoading, canManage }) => {
    ...
    return (
        <div
            className="table-card nhom-nhiem-vu-table-container"
            style={{
                overflowX: 'auto',
                background: '#fff',
                borderRadius: '8px',
        ...
        >
            {isLoading ? (
                ...
                <>
                    <table
                        className="custom-table nhom-nhiem-vu-table"
                                    ...
                                    <tr key={item.IdNhomNv}>
                                        ...
                                        <td>
                                            <div style={{ display: 'flex', gap: '15px', justifyContent: 'center', opacity: canManage ? 1 : 0.4, pointerEvents: canManage ? 'auto' : 'none' }}>
                                                ...
                                                <div className="action-btn delete-btn" onClick={() => onDelete(item.IdNhomNv)} title="Xóa">
...
export default QL_NhomNhiemVuListing;