 ...
 * của header nên nhân viên đọc được nguyên văn. Vì vậy ô này không phải thủ tục:
 ...
 * phải xét lại từ đầu sau khi nhân viên nộp lại.
 *
        ...
        <div className="modal-body">
          {soDongDaXet > 0 && (
            <div className="cd-hint cd-hint-warn" style={{ marginTop: 0 }}>
              ...
              dòng bạn đã xét sẽ bị xoá kết quả duyệt. Sau khi nhân viên nộp
          ...
          <div className="form-group" style={{ marginTop: "14px" }}>
            ...
            <textarea
              ...
              placeholder="Ví dụ: Dòng sáng kiến thiếu quyết định công nhận; khen thưởng cấp Trường đã kê trùng với dòng cấp ĐHĐN."
              disabled={dangGui}
            />
            <div className="cd-hint" style={{ marginTop: "6px" }}>
              Nhân viên sẽ đọc đúng nguyên văn nội dung này.
            </div>
          </div>
        </div>
...
export default TraLaiThanhTichModal;
