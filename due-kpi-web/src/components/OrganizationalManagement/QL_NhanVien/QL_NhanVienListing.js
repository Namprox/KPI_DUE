                            ...
                            {paginatedData.map((item, index) => {
                                ...
                                return (
                                    <tr key={item.IdNhanVien}>
                                        ...
                                        <td style={{ whiteSpace: 'nowrap' }}>
                                            ...
                                            {item.ScienceUserId ? (
                                                <div style={{ fontSize: '11px', color: '#059669', marginTop: '4px', display: 'flex', alignItems: 'center', gap: '4px' }}>
                                                    <i className="fa-solid fa-link"></i> DueScience: {item.ScienceUserId}
                                                </div>
                                            ) : (
                                                <div style={{ fontSize: '11px', color: '#94a3b8', marginTop: '4px', display: 'flex', alignItems: 'center', gap: '4px' }}>
                                                    <i className="fa-solid fa-link-slash"></i> Chưa liên kết DB
                                                </div>
                                            )}
                                        </td>
                                        ...
                                        <td style={{ color: item.TenDonVi ? 'inherit' : '#999', fontStyle: item.TenDonVi ? 'normal' : 'italic' }}>
                                        ...
                                        <td style={{ whiteSpace: 'nowrap' }}>
                                            <div style={{ fontSize: '13px', color: '#475569' }}>
                                                <i className="fa-regular fa-envelope" style={{ width: '16px', marginRight: '5px' }}></i>
                                                {item.Email || '---'}
                                            </div>
                                        </td>
