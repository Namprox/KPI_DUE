...
export const fetchBaiBao = (params) =>
  taiDanhSach("bai-bao", "bài báo", params);
export const fetchDeTai = (params) =>
  taiDanhSach("de-tai", "đề tài / dự án", params);
...
export const demMocDat = (tongHop) =>
  NHOM_MOC_NCKH.reduce(
    (tong, nhom) =>
      tong + nhom.danhSach.filter((moc) => !!tongHop?.[moc.key]).length,
    0,
  );
