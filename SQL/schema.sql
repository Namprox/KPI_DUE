...
CREATE TABLE phe_duyet (
    ...
    cap_duyet     NVARCHAR(20)   NOT NULL,    -- Mã chức vụ duyệt (tham chiếu chuc_vu.ma_chuc_vu)
    ...
    CONSTRAINT fk_pd_cap_duyet_ma_chuc_vu FOREIGN KEY (cap_duyet) REFERENCES chuc_vu(ma_chuc_vu),
